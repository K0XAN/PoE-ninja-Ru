...
### Рекомендую Русский Режим работы расширения, так как
- Английский и (Русский) — на данный момент работает с багами
- Русский — есть частичные непереведенные предметы.
